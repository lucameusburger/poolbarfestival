  ...
  return (
    <View style={{ width: '100%', top: 0, marginTop: 50 }}>
      ...
      <View style={{ flexDirection: 'row', width: '100%' }}>
        <TouchableOpacity
          style={{ width: nextTitle ? '50%' : '100%', paddingTop: 10, paddingBottom: 10, backgroundColor: '#2ECDA7' }}
          onPress={() => {
        ...
        {nextTitle && (
          <TouchableOpacity style={{ width: '50%', paddingTop: 10, paddingBottom: 10, backgroundColor: '#2ECDA7' }} onPress={next}>
