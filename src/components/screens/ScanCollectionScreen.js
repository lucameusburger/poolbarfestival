          ...
          >
            ...
            <View style={{}}>
              ...
              >
                ...
                <Text style={StylesMain.artistListDateText}>
                  {item.type_name}
                </Text>
              </View>
            </View>
...
const ScanCollectionScreen = ({}) => {
  ...
  useEffect(() => {
    ...
    setGeneratorsScannedCount(
      scans.filter((item) => item.type === "generator").length
    );
  ...
  return (
    <View style={StylesMain.mainView}>
      <FadeInView style={{ flex: 1, width: "100%", height: "100%" }}>
        ...
        >
          <ProgressBar
            value={generatorsSScannedCount}
            maxvalue={generatorsCount}
          />
          <View
            style={{
        ...
        <ScrollView style={{ flex: 1 }}>
          {!scans || !artists || !events || !generators ? (
            <LoadingText />
          ) : (
            <ScanCollection
              events={events}
